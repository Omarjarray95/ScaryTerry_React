...
export const PENDING = 'PENDING_USER_STORIES';
export const IN_PROGRESS = 'INPROGRESS_USER_STORIES';
export const TO_VERIFY = 'TOVERIFY_USER_STORIES';
export const DONE = 'DONE_USER_STORIES';
export const REQUEST_ERROR = 'REQUEST_ERROR';
export const READ_SPRINT_BACKLOG = 'READ_SPRINT_BACKLOG';

export function getSprintBacklog(id)
{
    return (dispatch) =>
        projectsService.getSprintBacklog(id)
            .then((sprintBacklog) =>
                {
                    return dispatch({
                        type: READ_SPRINT_BACKLOG,
                        payload: sprintBacklog
                    });
                }
            )
            .catch(error =>
...
export function getUserStories(id, state)
{
    var type = REQUEST_ERROR;
    switch (state)
    {
        case 'Pending':
            type = PENDING;
    ...
    return (dispatch) =>
        projectsService.getItemsByState(id, state)
            .then((data) =>
                {
                    return dispatch({
                        type: type,
