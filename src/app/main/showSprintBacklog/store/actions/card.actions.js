...
export const OPEN_CREATE_USER_STORY = '[SCRUMBOARD APP] OPEN_CREATE_USER_STORY';
export const OPEN_ASSIGN_USER_STORY = '[SCRUMBOARD APP] OPEN_ASSIGN_USER_STORY';
...
export function openCreateUserStoryDialog(item)
{
    return {
        type   : OPEN_CREATE_USER_STORY,
        payload: {operation: 'Create', item: item}
    }
}

export function openAssignUserStoryDialog(story, item)
{
    return {
        type   : OPEN_ASSIGN_USER_STORY,
        payload: {operation: 'Assign', story: story, item: item}
    }
}
