...
<Typography variant="subtitle1"> {mail.user.firstName} {mail.user.lastName}</Typography>
</div>

                ):(null)}
                    
                    <Typography variant="subtitle1">{ moment( mail.time).fromNow().toString()}</Typography>
                </div>
